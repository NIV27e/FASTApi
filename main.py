...
rating (descending). Also, this endpoint needs to support optional filtering of courses
based on domain.
"""
...
"""Endpoint to allow users to rate each chapter (positive/negative) 1 for Positive,
-1 For Negative, while aggregating all ratings for each course."""
